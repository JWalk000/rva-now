    ...
    <header className="relative isolate overflow-hidden bg-[#07060A]">
      ...
      <div className="relative z-10 mx-auto flex min-h-[58vh] max-w-7xl flex-col justify-end px-4 pb-12 pt-16 sm:px-6 sm:pb-16 sm:pt-20 lg:px-8 lg:min-h-[62vh]">
        <div className="flex flex-wrap items-start justify-between gap-6">
          ...
          <aside
            aria-label="Citipilot mobile app"
            className="animate-fade-up pointer-events-none mt-1 shrink-0 self-start sm:mt-2 sm:self-center"
            style={{ animationDelay: '220ms' }}
          >
            <div className="rotate-[-7deg] rounded-md border-2 border-dashed border-[#1B1724] bg-[#D4922A] px-3.5 py-2.5 shadow-[4px_4px_0_#1B1724] sm:px-4 sm:py-3">
              <p className="font-[family-name:var(--font-display)] text-[11px] font-extrabold uppercase leading-none tracking-[0.18em] text-[#1B1724]/75">
                Mobile
              </p>
              <p className="mt-1 font-[family-name:var(--font-display)] text-sm font-extrabold leading-tight text-[#1B1724] sm:text-base">
                App coming soon
              </p>
            </div>
          </aside>
