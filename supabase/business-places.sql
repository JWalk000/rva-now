-- Standalone SQL for Supabase SQL Editor (same as migration 20240708000000_business_places.sql)
-- Paste and run if `npx supabase db push` is unavailable.
...
drop policy if exists "Public read active approved business places" on public.business_places;
